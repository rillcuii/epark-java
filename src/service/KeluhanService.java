...
public class KeluhanService {
    ...
    public KeluhanService(Connection conn) {
        this.conn = conn;
    }

    public void insert(Keluhan keluhan) {
        String sql = "INSERT INTO keluhan (id_keluhan, users_id, nama_responden, judul_keluhan, keterangan_keluhan, photo_bukti_url, status_keluhan, created_at, updated_at) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public List<Keluhan> getAllByUserId(String userId) {
